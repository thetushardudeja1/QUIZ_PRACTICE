...
export const quizData: QuizData = {
  week1: [
    ...
    {
      question: "Identify the correct chronological order of the following educational institutions/initiatives associated with Raja Ram Mohan Roy:\n\nI. Foundation of the Anglo-Hindu School\nII. Supporting David Hare’s proposal for Hindu College\nIII. Establishment of Vedanta College",
      options: [
        "I, II, III",
        "II, I, III",
        "I, III, II",
    ...
    {
      question: "Raja Ram Mohan Roy regarded Western modern education primarily as a means of:",
      options: [
        "Propagating Christian missionary efforts",
        "Creating a new English-based hierarchy",
        "Collaboration with British rulers",
        "Social transformation and enlightenment"
      ],
      correct: 3
    },
    {
      question: "Which of the following is not correct regarding Raja Ram Mohan Roy's perspective towards British rule?",
      options: [
        "He opposed British rule only due to denial of civil liberties",
        "He believed British rule would promote civil liberties",
        "He preferred civil and religious liberty over political liberty",
        "He thought Indians lacked self-governance capacity"
      ],
      correct: 0
    },
    {
      question: "Modern Indian political thinkers differed from Western theorists in that:",
      options: [
        "They were purely academic",
        "Focused only on metaphysical issues",
        "They were activist thinkers combining theory and practice",
        "Rejected modernity"
      ],
      correct: 2
    },
    {
      ...
      options: [
        "Rooted in colonial context",
        "Combine activism and theory",
        "Have unique philosophical questions",
        "All of these"
      ],
      correct: 3
    },
    {
      question: "The 1823 press restriction order did NOT include which ground?",
      options: [
        "Threat to peace and order",
        "Creating hatred toward colonial government",
        "Defamation of officials",
        "Propagation of native religions"
      ],
      correct: 3
    },
    {
      question: "Which was NOT a ground Roy used to argue for press freedom?",
      options: [
        "Necessary for British rule stability",
        "Grievance redressal",
        "Platform for revolutionary nationalism",
        "Check on missionaries"
      ],
      correct: 2
    },
    {
      question: "The Brahmo Sabha (1828) was established to:",
      options: [
        "Replace Hinduism",
        "Create Brahmin elite club",
        "Promote rational religious reform and social transformation",
        "Preserve all traditions"
      ],
      correct: 2
    }
  ],
  week2: [
    {
      ...
      options: [
        ...
        "Revive old institutions and community festivals to unify divided peopled",
        "Follow its own destiny rather than merely imitate the West"
      ],
      correct: 1
    },
    {
      question: "Tagore discussed the duality of man, distinguishing between the 'animal aspect' concerned with the fulfilment of necessities, and the 'Universal man' who strives for something greater. What does the 'Universal Man' strive for?",
      options: [
        "Happiness",
        "Necessities",
        "Beauty",
    ...
    },
    {
      ...
      options: [
        ...
        "Tagore argued that obsession with nationalism could lead to war, hatred, and mutual suspicion among the nations."
      ],
      correct: 0
    },
    {
  ...
  week3: [
    ...
    {
      question: "Nationalism according to Aurobindo was not merely a political programme, but:",
      options: [
        "A loose confederation",
        "A religion gifted by God",
        "Objectification of the universal",
        "A decolonised vision"
      ],
      correct: 1
    },
    {
    ...
    {
      question: "Which of the following statements correctly represents Sri Aurobindo's perspective on the 'Spiritual religion of humanity'?\n\n1. It requires a universal religious system.\n2. It aims for psychological unification of people while respecting socio-cultural diversity.\n3. It implies that spiritual life does not prioritize freedom.\n4. It is primarily concerned with solving material problems before addressing spiritual reality.",
      options: [
        "1 and 4 only",
        "2 only",
        "2 and 3 only",
    ...
    {
      question: "Which one of the following sentences is incorrect about Aurobindo's views on the Gita?",
      options: [
        "It should not be understood merely in its metaphysical connotations of ancient times.",
        "It should be understood in its renewed relevance to living truths.",
        "It cannot offer much in discovering the horizons of the future.",
        "It has a future-oriented approach towards living truths."
      ],
      correct: 2
    },
    {
      ...
      options: [
        ...
        "Spiritual transformation of people",
        "Western education",
        "Economic equality"
      ],
      correct: 1
